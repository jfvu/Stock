...
public class ThirtyFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_thirty)
    RecyclerView mRvFragmentThirty;
    Unbinder unbinder;

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_thirty;
    }
    ...
    protected void initView() {
        mRvFragmentThirty.setLayoutManager(new GridLayoutManager(getActivity(),3));
        mRvFragmentThirty.setAdapter(new MyAdapter());
    }
