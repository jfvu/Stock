...
public class FundamentalsActivity extends BaseActivity {
    ...
    private String[] groups = {"市净率", "市盈率", "换手率", "股票价格", "总股本",
            "总市值", "流通股", "流通市值"};
    private List<List> childs = new ArrayList<>();
    private List<String> child1, child2, child3, child4, child5, child6, child7, child8;
    ...
    protected void initView() {
        ...
        child7 = new ArrayList<>();

        child8 = new ArrayList<>();
    ...
    protected int getLayoutId() {
        return R.layout.activity_fundamentals;
    }
    ...
    private void showPickerView() {
        ...
        if (mInt == 0) {
            options1Items.clear();
            for (int i = 2; i < 501; i++) {
                options1Items.add(String.valueOf((float)i/10));
            }
        } else if (mInt == 1) {
            options1Items.clear();
            for (int i = 1; i < 501; i++) {
            ...
            for (int i = 1; i < 10000; i++) {
                options1Items.add(String.valueOf((float)i/10)+"亿");
            }
        } else if (mInt == 5) {
            options1Items.clear();
            for (int i = 1; i < 1000; i++) {
                options1Items.add(String.valueOf(i)+"亿");
            }
        }
        else if (mInt == 6) {
            options1Items.clear();
    ...
    private String setMessage() {
        ...
        if (child6.size() != 0) {
            ...
            s = s + groups[6] + child7.toString();
        }
        if (child8.size() != 0) {
            s = s + groups[7] + child8.toString();
        }
        return s;
    }
}
