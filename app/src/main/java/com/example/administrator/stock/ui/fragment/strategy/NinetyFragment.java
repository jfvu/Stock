...
public class NinetyFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_ninety)
    RecyclerView mRvFragmentNinety;
    Unbinder unbinder;

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_ninety;
    }
    ...
    protected void initView() {
        mRvFragmentNinety.setLayoutManager(new GridLayoutManager(getActivity(),3));
        mRvFragmentNinety.setAdapter(new MyAdapter());
    }
