...
public class YearFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_year)
    RecyclerView mRvFragmentYear;
    Unbinder unbinder;
    ...
    protected void initView() {
        mRvFragmentYear.setLayoutManager(new GridLayoutManager(getActivity(),3));
        mRvFragmentYear.setAdapter(new MyAdapter());
    }
