...
public class OptionalPop extends PopupWindow {
    ...
    public OptionalPop(Context context, View.OnClickListener onClickListener){
        this.view = LayoutInflater.from(context).inflate(R.layout.pop_optional,null);
