...
public class DayFragment extends BaseFragment {
    @BindView(R.id.rv_fragment_day)
    RecyclerView mRvFragmentDay;
    Unbinder unbinder;
    ...
    protected void initView() {
        mRvFragmentDay.setLayoutManager(new GridLayoutManager(getActivity(),3));
        mRvFragmentDay.setAdapter(new MyAdapter());
    }
